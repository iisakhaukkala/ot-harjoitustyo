...
class TestService(unittest.TestCase):
    ...
    def test_edit_email(self):
        ...
        self.assertEqual(register_service._user,
                         ("abc", "abcdefgh", None, "asd@asd", None, None, 0))
    ...
    def test_get_all_non_members(self):
        ...
        register_service.create_user("123", "12345678")
        self.assertEqual(
            register_service.get_all_non_members(), [("123", None)])
    ...
    def test_make_admin(self):
        ...
        self.assertEqual(register_service._user,
                         ("abc", "abcdefgh", None, None, None, None, 1))
